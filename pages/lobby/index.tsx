                ...
                <div>
                  {lobby.songList &&
                    lobby.songList.map((item: any, index: number) => {
                      return <div key={item.songId}>{item.songTitle}<span onClick={()=>RemoveSong(item)}> remove</span></div>;
                    })}
                  {lobby.songList && isMaster ? (
                    lobby.songList && (
                      <video
                        id="video-player"
                        key={lobby.songList[videoIndex].songId}
                        controls
                        autoPlay
                      ...
                      >
                        ...
                        <audio id="audio-player" controls>
                          <source
                            src={`api/stream-audio?id=${lobby.songList[videoIndex].songId}`}
                          />
                        </audio>
                      </video>
                    )
                  ) : (
                    <div>Playing: {lobby.songList && lobby.songList[videoIndex].songTitle}</div>
                  )}
